...
public class GsonFormEncodedRequest<T> extends Request<T> {
     ...
     */
    public GsonFormEncodedRequest(String contentType, int method, String url, Class<T> clazz, Map<String, String> headers, Map<String, String> params,
    ...
    private void addAuthorizationToHeader() {
        ...
        if (token != null && headers.get("Authorization") == null) {
